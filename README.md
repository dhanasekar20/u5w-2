# Unit 5 workshop-2
# Draw any two different shapes and add motion  with the OpenGL ES in  android.


## AIM:
To Draw any two different shapes and add motion  with the OpenGL ES in  android.
...
## RESULT
Thus,the program to draw any two different shapes and add motion  with the OpenGL ES in  android is implemented.
